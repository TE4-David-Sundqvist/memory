const img = ['1_pig', '2_squirrel', '3_rabbit', '4_frog', '5_fox', '6_bear', '7_monkey', '8_panda', '9_chick', '10_tiger', '11_penguin', '12_racoon']
const background = 'img/back.png'
...
function render_scoreboard (value) {
  ...
  const highscores = Object.entries(localStorage)
...
function postToScoreboard () {
  const input = document.querySelectorAll('#form input')[0].value
  const score = document.querySelector('.yourscore > h2').innerText
